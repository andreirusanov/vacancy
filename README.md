...
### 👉 [Открыть полное описание вакансии](./Senior_System_Analyst_Na_Polke.md) внутри которого:

`Контекст продукта` | `Описание задач` | `Ожидания от Senior` | `Пример типовой активности` | `Наше предложение`
...
### 📬 Вопросы можно задать, используя контакты:

`TG: @funeralburg` | `Phone/WP: +79168446852` | `Email: a.rusanov@napolke.com`

Или сделав запрос через **Issues** репозитория.
